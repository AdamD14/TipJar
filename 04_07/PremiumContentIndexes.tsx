  ...
  return (
    <div className="max-w-5xl mx-auto space-y-4">
      <div className="flex items-center justify-between">
        ...
        <Link href="/studio/monetization/premium-content/products/create">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {products?.map((product) => (
          <Link
            key={product.id}
            href={`/studio/monetization/premium-content/products/${product.id}`}
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-4">
      <div className="flex items-center justify-between">
        ...
        <Link href="/studio/monetization/premium-content/tiers/create">
          <Button variant="primary" size="sm" leftIcon={<Plus size={14} />}>
            New tier
          </Button>
        </Link>
      ...
      <div className="space-y-3">
        {[...(tiers ?? [])]
          ...
          .map((tier) => (
            <Link
              key={tier.id}
              href={`/studio/monetization/premium-content/tiers/${tier.id}`}
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-4">
      <div className="flex items-center justify-between">
        ...
        <Link href="/studio/monetization/premium-content/bundles/create">
          <Button variant="primary" size="sm" leftIcon={<Plus size={14} />}>
            New bundle
          </Button>
        </Link>
