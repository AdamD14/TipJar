import { PutObjectCommand, S3Client } from "https://esm.sh/@aws-sdk/client-s3@3.485.0";
...
Deno.serve(async (req)=>{
  ...
  try {
    ...
    const reservePromise = fetch(`${Deno.env.get("NESTJS_INTERNAL_URL")}/api/v1/media/reserve-slot`, {
      method: "POST",
      headers: {
