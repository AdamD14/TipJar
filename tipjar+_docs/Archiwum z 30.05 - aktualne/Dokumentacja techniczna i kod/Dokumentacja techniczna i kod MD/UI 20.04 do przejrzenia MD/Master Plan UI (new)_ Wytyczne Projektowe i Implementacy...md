...
Główny punkt akcji, pływający nad interfejsem, używany najczęściej na urządzeniach mobilnych
do wywoływania Asystenta AI lub szybkiej wpłaty.

●  Wymiary i Pozycjonowanie: Kontener 56x56px w kształcie idealnego koła
...
●  Stany Interakcji i Kolor:

○  Default: Tło --gold-400, ikona --teal-800.
○  Hover: Tło --gold-500, cień poszerza się (Elevation 3).
○  Active (Kliknięcie): transform: scale(0.92), tło --gold-600. Wyzwala wibrację

haptyczną typu Impact/Tick.

○  Focus: Pierścień --purple-300 oddalony o 4px.

●  Cieniowanie: Wymaga silnego rzutu, by odciąć się od treści pod spodem: box-shadow: 0

12px 24px -4px rgba(0, 0, 0, 0.6), 0 0 12px rgba(252, 194, 1, 0.2) (Złota poświata).
●  Zachowanie na Scrollu (Scroll Behavior): FAB reaguje na kierunek przewijania.
Przewijanie w dół (ukrycie): transform: translateY(150%) scale(0.9) z opacity 0.
Przewijanie w górę (powrót): transform: translateY(0) scale(1) z opacity 1. Animacja
wykorzystuje --ease-spring (czas 400ms) dając efekt sprężystego "wyskoku".
...
wystarcza do zbudowania hierarchii. System preferuje minimalizm.

●  Geometria i Kolor: Grubość zawsze 1px. Kolor domyślny to --border-subtle zredukowany

do półprzezroczystości, aby łagodnie wtapiał się w tło, lub sztywna dyrektywa
background-color: rgba(255, 255, 255, 0.05).

●  Warianty Układu:

○  Full-bleed: Linia od krawędzi do krawędzi ekranu (stosowana w listach

○

powiadomień i drawerach).
Inset: Linia wcięta o 16px lub 24px (zazwyczaj wyrównana do tekstu, z
pominięciem marginesu ikony/awatara). Stosowana na długich listach kontaktów.
○  Vertical (Pionowe): Wysokość dopasowana do kontenera nadrzędnego (często z
marginesem pionowym np. 8px z góry i dołu), stosowana w górnych paskach
nawigacji lub toolbarach do oddzielania grup ikon.

●  Dostępność: Każdy separator mający wyłącznie funkcję dekoracyjną musi posiadać

atrybuty role="separator" oraz aria-hidden="true", aby był ignorowany przez czytniki
ekranowe.
