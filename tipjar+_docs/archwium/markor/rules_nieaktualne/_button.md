...
- **Spinner Style**: Spinner powinien być minimalistycznym okręgiem SVG z animacją stroke-dasharray, w kolorze tekstu przycisku (np. Ciemnoturkusowy na Złotym), aby zachować spójność.
...
- **Secondary Gold (Złoty Border)**: Powinien być używany w kontekście „Premium” lub „Brand”. Np. akcja „Zobacz ofertę VIP”, „Dołącz do klubu”. Jest to most pomiędzy głównym CTA a tłem.
