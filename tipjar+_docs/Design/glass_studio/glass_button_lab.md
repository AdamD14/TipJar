...
const PRESETS: Record<string, GlassConfig> = {
  ...
  "Frosted Gold": {
    ...
    gradientStrength: 0.20, edgeSoftness: 0.65, baseHex: "#b8860b", gradFromHex: "#daa520", 
    gradToHex: "#8b6508", gradAngle: 135, gradType: "linear", borderAlpha: 0.25, 
  ...
  "Cyber Purple": {
    ...
    gradientStrength: 0.25, edgeSoftness: 0.30, baseHex: "#4b0082", gradFromHex: "#8a2be2", 
    gradToHex: "#28004d", gradAngle: 90, gradType: "radial", borderAlpha: 0.15, 
...
function computeGlassVars(config: GlassConfig): GlassComputedVars {
  const bg = rgbaFromHex(config.baseHex, config.glass);
...
function useGlassButton(config: GlassConfig, options: UseGlassButtonOptions = {}) {
  ...
  // Background calculation for preview context & main app wrapper
...
export default function App() {
  ...
  return (
    <div
      className="flex flex-col lg:flex-row min-h-screen text-white font-sans"
    ...
    >
      ...
      <div className="w-full lg:w-[420px] bg-black/40 border-r border-white/10 backdrop-blur-xl p-6 overflow-y-auto h-auto lg:h-screen z-10 flex-shrink-0">
        ...
        <div className="space-y-6">
          ...
          <Section title="Colors & Gradient">
             <Control label="Background Gradient Type">
              <select 
                className="w-full bg-[#1a1a1a] border border-white/10 rounded px-2 py-2 text-sm outline-none focus:border-white/30"
            ...
            {config.gradType === 'linear' && (
              <Control label={`Gradient Angle: ${config.gradAngle}°`}>
            ...
            <div className="grid grid-cols-3 gap-2 mt-2">
              ...
              <ColorInput label="Base (Glass)" value={config.baseHex} onChange={(v) => updateConfig("baseHex", v)} />
      ...
      <div className="flex-1 p-6 lg:p-12 overflow-y-auto w-full">
        <div className="max-w-3xl mx-auto space-y-8">
          ...
          {/* Live Preview */}
          <div className="bg-white/5 border border-white/10 rounded-3xl p-12 min-h-[300px] flex flex-col items-center justify-center relative overflow-hidden backdrop-blur-sm shadow-2xl">
