...
export default function RecentSupportPage() {
  return (
      ...
      <div className="max-w-6xl mx-auto space-y-8 animate-in fade-in duration-500">
        <div className="border-b border-teal-500/10 pb-6">
          ...
          <p className="text-sm text-text-tertiary leading-relaxed">
            A gallery of human gestures — proof that your work moves people.
            Each entry is a micro-story of the relationship you built.
          </p>
        </div>
        <RecentSupport />
      </div>
