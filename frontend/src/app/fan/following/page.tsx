    ...
    >
      <header className="bg-[#003737] text-white p-4 flex justify-between items-center">
        ...
        <nav>
          ...
          <Link href="/fan/following" className="px-3 text-[#FFD700]">
            Following
          </Link>
      ...
      <section className="p-8">
        ...
        <ul className="list-disc pl-5 text-gray-700">
          <li>
            <Link href="/@Alice" className="hover:text-[#003737]">
              @Alice
            </Link>{" "}
            – Last supported on 2025-06-15 ($5)
          </li>
          <li>
            <Link href="/@Charlie" className="hover:text-[#003737]">
              @Charlie
            </Link>{" "}
            – Last supported on 2025-05-30 ($3)
          </li>
        </ul>
      </section>
    </main>
