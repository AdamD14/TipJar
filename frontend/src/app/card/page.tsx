export default function CardPage() {
  return (
    <div className="grid grid-cols-2 gap-6 justify-center content-center justify-items-center items-center min-h-screen py-12">
      <div
        className="w-[480px] h-[240px] rounded-xl"
        style={{
          background: 'linear-gradient(110deg in oklch, oklch(0.1463 0.0258 214.5) 0%, oklch(0.246939 0.042152 194.7689) 50%, oklch(0.1463 0.0258 214.5) 100%)',
        }}
      />
      <div
        className="w-[480px] h-[240px] rounded-xl"
      ...
      <div
        className="w-[480px] h-[240px] rounded-xl"
        style={{
          background: 'linear-gradient(110deg in oklch, oklch(0.22 0.0718 188.47) 0%, oklch(0.246939 0.042152 194.7689) 50%, oklch(0.2647 0.0493 205.42) 100%)',
        }}
      />
      <div
        className="w-[480px] h-[240px] rounded-xl"
