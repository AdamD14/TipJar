  ...
  return (
    ...
    >
      <header className="bg-[#003737] text-white p-4 flex justify-between items-center">
        ...
        <nav>
          <Link href="/creator/dashboard" className="px-3 text-[#FFD700]">
            Dashboard
          </Link>
          <Link
      ...
      <section className="p-8">
        ...
        <p className="mb-4">
          Total Tips Received: <span className="font-bold">$123.45</span>
        </p>
        <p className="mb-6">
          Current Balance: <span className="font-bold">$67.89</span>
        </p>
