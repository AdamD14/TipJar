  ...
  return (
    ...
    >
      <header className="bg-[#003737] text-white p-4 flex justify-between items-center">
        ...
        <nav>
          <Link href="/creator/dashboard" className="px-3 hover:text-[#FFD700]">
            Dashboard
          </Link>
          <Link href="/creator/withdrawals" className="px-3 text-[#FFD700]">
            Withdrawals
          </Link>
          <Link href="/creator/settings" className="px-3 hover:text-[#FFD700]">
            Settings
          </Link>
      ...
      <section className="p-8">
        ...
        <p className="mb-4">
          Current Balance: <span className="font-bold">$67.89</span> USDC
        </p>
        <form className="space-y-4 max-w-md">
          ...
          <button
            type="submit"
            className="bg-[#003737] text-white py-2 px-4 rounded"
          >
            Withdraw
          </button>
        </form>
