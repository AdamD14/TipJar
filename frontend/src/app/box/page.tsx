      ...
      <div className="max-w-5xl w-full space-y-8">
        ...
        <header className="space-y-2">
          ...
          <p className="text-slate-400 text-sm md:text-base">
            Poniższe karty używają maski SVG <code>objectBoundingBox</code>, gradientu oświetlenia 110° oraz wektorowej ochrony linii.
          </p>
        </header>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <Box variant="premium" interactive>
            <div className="space-y-2 text-white">
              <span className="text-xs font-mono uppercase tracking-wider text-amber-400">Wariant: Premium</span>
              <h2 className="text-xl font-bold text-amber-100">Luksusowa Refrakcja</h2>
              <p className="text-sm text-amber-100/70">
                Kąt 110 stopni symuluje naturalne, asymetryczne opadanie światła z góry i z lewej strony. Wektorowa ramka ma stałą grubość.
              </p>
            </div>
          </Box>
          ...
          <Box variant="purple" interactive>
            <div className="space-y-2 text-white">
              <span className="text-xs font-mono uppercase tracking-wider text-purple-300">Wariant: Purple</span>
              <h2 className="text-xl font-bold">Topologia Connection</h2>
              <p className="text-sm text-purple-100/70">
                Maska idealnie dopasowuje się do wymiarów karty bez używania jakichkolwiek zapytań @media w CSS.
              </p>
            </div>
          </Box>
          ...
          <Box variant="modal">
            <div className="space-y-2 text-white">
              <span className="text-xs font-mono uppercase tracking-wider text-slate-400">Wariant: Modal</span>
              <h2 className="text-xl font-bold text-slate-200">Frozen Glass 3.0</h2>
              <p className="text-sm text-slate-400">
                Ta karta nie ma flagi <code>interactive</code>. Leży płasko, nie zmienia tła pod wpływem myszki i służy jako czysty kontener na dane.
              </p>
            </div>
          </Box>
