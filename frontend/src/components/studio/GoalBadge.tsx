    ...
    <div className={`inline-flex items-center gap-2 rounded-full bg-[#FFD700]/10 border border-[#FFD700]/30 px-3 py-1.5 text-xs ${className}`}>
      <div className="relative w-4 h-4">
        <svg className="w-4 h-4 transform -rotate-90" viewBox="0 0 24 24">
          <circle cx="12" cy="12" r="10" stroke="rgba(255, 215, 0, 0.2)" strokeWidth="3" fill="none" />
          <circle
            cx="12" cy="12" r="10"
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <span className="text-[8px] font-bold text-[#FFD700]">{clampedPercent}%</span>
        </div>
      </div>
      <span className="font-medium text-[#FFD700] uppercase tracking-tighter">
