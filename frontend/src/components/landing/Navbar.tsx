...
export default function Navbar() {
  ...
  const navbarClasses = `fixed top-0 left-0 w-full z-50 transition-opacity duration-500 ${
  ...
  return (
    <header className={navbarClasses}>
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-tj-turquoise bg-opacity-90 backdrop-blur-sm">
