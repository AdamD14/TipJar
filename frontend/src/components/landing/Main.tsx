    ...
    <div className="min-h-screen bg-[#006D6D]">
      ...
      <main>
        <div className="container mx-auto px-4 py-16 text-center">
          <h1 className="text-[#FFD700] text-6xl md:text-7xl font-bold mb-6 animate-fadeIn">
            TipIT
          </h1>
          <p className="text-xl md:text-2xl text-white mb-8 max-w-3xl mx-auto">
            Support your favorite creators instantly and without borders, using
            stable USDC. Simple, fast, global.
          </p>
          <div className="mb-12">
            <Image
          ...
          <div className="flex flex-col md:flex-row gap-6 justify-center mb-16">
            <button className="bg-[#FFD700] text-[#004C4C] px-8 py-4 rounded-full font-bold text-lg hover:bg-[#FFE55C] transition-all transform hover:scale-105">
              Register as Creator
            </button>
            <Link
              href="/discover"
              className="bg-transparent border-2 border-[#FFD700] text-[#FFD700] px-8 py-4 rounded-full font-bold text-lg hover:bg-[#FFD700] hover:text-[#004C4C] transition-all text-center"
            >
              Discover Creators
            </Link>
          </div>
          ...
          <section className="mb-20">
            <h2 className="text-[#FFD700] text-4xl font-bold mb-12">
              How it Works
            </h2>
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-[#008080] p-8 rounded-xl">
                <h3 className="text-[#FFD700] text-2xl font-bold mb-4">
                  For Fans
                </h3>
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <p className="text-left text-white">
                      Find your favorite creators on TipJar
                    </p>
                  </div>
                  <div className="flex items-start gap-4">
                    <HandCoins className="text-[#FFD700] h-6 w-6 mt-1" />
                    <p className="text-left text-white">
                      Send tips easily with USDC
                    </p>
                  </div>
                  <div className="flex items-start gap-4">
                    <Star className="text-[#FFD700] h-6 w-6 mt-1" />
                    <p className="text-left text-white">
                      Get exclusive perks and recognition
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-[#008080] p-8 rounded-xl transform hover:scale-105 transition-transform">
                ...
                <p className="text-white">
                  Only <span className="text-[#FFD700]">1%</span> platform fee
                </p>
              </div>
              <div className="bg-[#008080] p-8 rounded-xl transform hover:scale-105 transition-transform">
          ...
          <section className="mb-20">
            <h2 className="text-[#FFD700] text-4xl font-bold mb-8">
              Join Our Community
            </h2>
