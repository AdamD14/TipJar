      ...
      <div className="relative z-10 w-full min-h-screen py-20 px-4 md:px-8">
        <div className="w-full h-full flex flex-col justify-center gap-10 md:gap-16 lg:gap-20">
          ...
          <div className="w-full">
            <div className="group bg-black/40 backdrop-blur-sm border border-white/10 rounded-lg p-6 transition-all duration-300 hover:border-gold-400/60 hover:shadow-[0_0_0_4px_rgba(255,215,0,0.10)_inset]">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className="text-lg sm:text-lg md:text-lg lg:text-xl font-semibold text-muted">Simplicity &amp; Payment Flexibility</h3>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-16 lg:gap-16">
            ...
            <div className="group bg-black/40 backdrop-blur-sm border border-white/10 rounded-lg p-6 transition-all duration-300 hover:border-gold-400/60 hover:shadow-[0_0_0_4px_rgba(255,215,0,0.10)_inset]">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className="text-lg sm:text-lg md:text-lg lg:text-xl font-semibold text-muted">Secure and Transparent</h3>
              </div>
              <p className="text-base md:text-base lg:text-md text-muted leading-relaxed">
            ...
            <div className="group bg-black/40 backdrop-blur-sm border-2 border-gold-400 rounded-lg p-6 transition-all duration-300 hover:border-gold-400 hover:shadow-[0_0_0_4px_rgba(255,215,0,0.20)_inset]">
              <div className="flex items-center gap-3 mb-3">
                <div className="w-8 h-8 bg-gold-400/10 rounded flex items-center justify-center flex-shrink-0 transition-all duration-300 group-hover:bg-gold-400/20">
                  <DollarSign className="w-5 h-5 text-gold-400" />
                </div>
                <h3 className="text-lg sm:text-lg md:text-lg lg:text-xl font-semibold text-gold-400">LOW FEES &amp; Direct Support</h3>
              </div>
              <p className="text-base md:text-base lg:text-md text-muted leading-relaxed">
                A simple, <span className="text-gold-400">flat 5% service</span> fee ensures creators receive the
            ...
            <div className="group bg-black/40 backdrop-blur-sm border border-white/10 rounded-lg p-6 transition-all duration-300 hover:border-gold-400/60 hover:shadow-[0_0_0_4px_rgba(255,215,0,0.10)_inset]">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className="text-lg sm:text-lg md:text-lg lg:text-xl font-semibold text-muted">Global</h3>
              </div>
              <p className="text-base md:text-base lg:text-md text-muted leading-relaxed">
          ...
          <div className="w-full">
            <div className="group bg-black/40 backdrop-blur-sm border border-white/10 rounded-lg p-6 transition-all duration-300 hover:border-gold-400/60 hover:shadow-[0_0_0_4px_rgba(255,215,0,0.10)_inset]">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className="text-lg sm:text-lg md:text-lg lg:text-xl font-semibold text-muted">Instant Payouts</h3>
              </div>
              <p className="text-base md:text-base lg:text-md text-muted leading-relaxed">
          ...
          <div className="w-full mt-6">
            <div className="flex items-center justify-between">
              <Link
                href="#learn"
                className="group inline-flex items-center gap-2 text-base md:text-base lg:text-md font-medium text-muted underline-offset-4 hover:underline transition"
              >
              ...
              <button
                ...
                className="inline-flex h-12 w-12 items-center justify-center rounded-full border border-muted/60 text-muted transition hover:-translate-y-0.5 hover:bg-muted/10"
              >
