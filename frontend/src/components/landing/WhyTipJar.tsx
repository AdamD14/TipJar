          ...
          <div className="w-full mt-6">
            <div className="flex items-center justify-between">
              <Button
                ...
                variant="link"
                size="sm"
                className="group text-base md:text-base lg:text-md font-medium text-text-ds-secondary"
              >
              ...
              <Button
                ...
                className="h-12 w-12 rounded-full border border-text-ds-tertiary/60 text-text-ds-tertiary hover:-translate-y-0.5 hover:bg-white/10"
              >
