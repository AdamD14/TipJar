...
const TRANSFORMATION = "c_scale,w_250,h_250/e_background_removal:fineedges/f_webp/q_auto:eco";
...
const PLATFORM_STYLES: Record<string, { 
  ...
  "visual-creator": { 
    ...
    full: "#8134AF",
    isGradient: true,
    gradientMid: "linear-gradient(135deg, #DD2A7B 0%, #8134AF 50%, #F58529 100%)",
    gradientFull: "linear-gradient(135deg, #F58529 0%, #DD2A7B 50%, #8134AF 100%)",
  },
...
const ARCHETYPES = [
  { id: "live-streamer", label: "Live Streamer / Interactive Entertainer", icon: buildIconUrl("11_cmnf7m") },
  { id: "lifestyle-storyteller", label: "Lifestyle Storyteller / Personal Brand", icon: buildIconUrl("16_q76o9v") },
  { id: "visual-creator", label: "Visual Content Creator / Aesthetic Influencer", icon: buildIconUrl("14_r2vcut") },
  { id: "knowledge-architect", label: "Knowledge Architect / Educational Creator", icon: buildIconUrl("15_hwkwrb") },
  { id: "micro-entertainer", label: "Micro-Entertainer / Viral Content Specialist", icon: buildIconUrl("12_ek54hp") },
  { id: "health-coach", label: "Health & Performance Coach", icon: buildIconUrl("13_xquypf") },
];
    ...
    <>
      ...
      <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-4 p-2">
        {ARCHETYPES.map((archetype) => {
          ...
          const isGlitchHovered = hoveredGlitch === archetype.id && colors.hasGlitch;
          const isGlitchSelected = isSelected && colors.hasGlitch && glitchActive;
          ...
          return (
            <button
              ...
              onMouseEnter={() => colors.hasGlitch && setHoveredGlitch(archetype.id)}
            ...
            >
              ...
              <div 
                ...
                style={{
                  border: colors.isGradient && isSelected ? "none" : isSelected ? `2px solid ${colors.full}` : "2px solid #7aaaab",
                  background: colors.isGradient && isSelected ? colors.gradientFull : "none",
                  WebkitMask: colors.isGradient && isSelected ? "linear-gradient(#fff 0 0) content-box, linear-gradient(#fff 0 0)" : "none",
                  WebkitMaskComposite: colors.isGradient && isSelected ? "xor" as const : "source-over" as const,
                  maskComposite: colors.isGradient && isSelected ? "exclude" : "add",
              ...
              {colors.hasGlitch && (isGlitchHovered || isGlitchSelected) && (
                <div 
                  ...
                  style={{
                    ...
                    opacity: 0.7,
                    animation: "glitch-shift 0.3s cubic-bezier(0.25, 0.46, 0.45, 0.94) infinite",
                  }}
                />
              )}
              ...
              {colors.hasGlitch && (isGlitchHovered || isGlitchSelected) && (
                <div 
                  ...
                  style={{
                    ...
                    opacity: 0.7,
                    animation: "glitch-shift 0.3s cubic-bezier(0.25, 0.46, 0.45, 0.94) infinite reverse",
                  }}
                />
              )}
              ...
              {!colors.hasGlitch && (
                <div 
                  ...
                  style={{
                    border: colors.isGradient ? "none" : `2px solid ${colors.mid}`,
                    background: colors.isGradient ? colors.gradientMid : "none",
                    WebkitMask: colors.isGradient ? "linear-gradient(#fff 0 0) content-box, linear-gradient(#fff 0 0)" : "none",
                    WebkitMaskComposite: colors.isGradient ? "xor" as const : "source-over" as const,
              ...
              <div className="w-[90px] h-[90px] md:w-[180px] md:h-[180px] relative shrink-0 rounded-xl z-10">
                <Image src={archetype.icon} alt={archetype.label} fill priority sizes="(max-width: 768px) 90px, 180px" className="object-cover w-full h-full" />
              </div>
              ...
              {colors.isGradient && isSelected ? (
                ...
                <span
                  ...
                  style={{
                    color: isSelected 
                      ? (archetype.id === "knowledge-architect" ? "#000000" : colors.full)
                      : "#e5e7eb",
                  }}
                >
                  {archetype.label}
              ...
              {isSelected && (
                <div 
                  ...
                  style={{ backgroundColor: colors.full, boxShadow: `0 0 10px ${colors.full}` }}
                />
              )}
            </button>
          );
