...
> = {
  ...
  "programs-coaching": {
    ...
    description: "Guided transformation programs",
  },
  "digital-assets": {
    label: "Digital Assets",
    description: "Templates, presets, downloadable files",
  },
  "premium-media": {
    label: "Premium Media",
    description: "Exclusive videos, photos, audio",
  },
  "live-experiences": {
    label: "Live Experiences",
    description: "Real-time events and sessions",
  },
};

export const ACCESS_MODEL_META: Record<
  AccessModel,
...
export const DELIVERY_MODEL_META: Record<
  DeliveryModel,
  { label: string; description: string }
> = {
  instant: {
  ...
  "scheduled-drop": {
    ...
    description: "Unlocks at a specific date/time",
  },
  booking: {
    label: "Booking / Live",
    description: "Access during scheduled session",
  },
};