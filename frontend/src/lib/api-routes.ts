export const API = {
  ...
  CIRCLE: {
    WALLET_CREATE: "/api/v1/circle/wallet/create",
    WALLET: "/api/v1/circle/wallet",
    BALANCE: "/api/v1/circle/wallet/balance",
    TXS: "/api/v1/circle/wallet/transactions",
    DEPOSIT_HOSTED: "/api/v1/circle/deposit-hosted",
    WITHDRAW: "/api/v1/circle/withdraw",
    CCTP_TRANSFER: "/api/v1/circle/cctp/transfer",
    WEBHOOK: "/api/v1/circle/webhook",
    ADMIN_WALLETS: "/api/v1/circle/admin/circle/wallets",
  },
  CREATORS: "/api/v1/creators",
  FAN: {
    BALANCE: "/api/v1/fan/wallet/balance",
    TIPS_HISTORY: "/api/v1/fan/tips/history",
  },
